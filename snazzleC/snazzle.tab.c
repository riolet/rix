...
#line 78 "snazzle.tab.c" /* yacc.c:339  */
...
#line 1238 "snazzle.tab.c" /* yacc.c:1646  */
  ...
  case 11:
#line 62 "snazzle.y" /* yacc.c:1646  */
    { printf("new snazzle: %d, %d, %d, %d, %s\n", (yyvsp[-4].ival), (yyvsp[-3].ival), (yyvsp[-2].ival), (yyvsp[-1].ival), (yyvsp[0].sval)); }
