...
#define _$_Array_Initialize_0(_$v$_size__,_$v$_type)  ({ \
    ...
    _$v$_arr.data = (_$v$_type *) alloca(_$v$_size__ * sizeof(_$v$_type));\
    memset (_$v$_arr.data,0,_$v$_size__ * sizeof(_$v$_type)); \
    _$v$_arr;\
})

#define _$_Array_Initialize_1(_$v$_size__,_$v$_type) alloca(_$v$_size__ * _$v$_type)

#define _$_Array_object_at_0(_$v$_arr__,_$v$_idx__, _$v$_typeRet) ((_$v$_typeRet *) _$v$_arr__.data)[_$v$_idx__]
#define _$_Array_object_at_1(_$v$_arr__,_$v$_idx__, _$v$_typeRet) _$v$_arr__[_$v$_idx__]


#define _$_Array_set_object_at_0(_$v$_arr, _$v$_idx, _$v$_elem, _$v$_typeRet) ({\
    if (_$v$_idx>_$v$_arr.last) {\
        _$v$_arr.last=_$v$_idx;\
        debugPrintf("Last %d\n",_$v$_idx);\
    }\
    setBit(_$v$_arr.bitArray,_$v$_idx);\
    ((_$v$_typeRet *) _$v$_arr.data)[_$v$_idx]=_$v$_elem;\
    _$v$_arr;\
})

#define _$_Array_set_object_at_1(_$v$_arr, _$v$_idx, _$v$_elem, _$v$_typeRet) ({\
        _$v$_arr[_$v$_idx] = _$v$_elem;\
        })

#define Array_$_Array_$_int(_$v$_size__, _$v$_primYtpe, _$v$_type) ({\
    xcat(_$_Array_Initialize_,_$v$_primYtpe)(_$v$_size__, _$v$_type);\
})


#define Array_$_putObjectAtIndex_$_Generic_$$_$_Generic_$$(_$v$_arr, _$v$_idx, _$v$_primIdx, _$v$_elem, _$v$_primElem,\
                                                            _$v$_primRet, _$v$_typeRet) ({\
    xcat(_$_Array_set_object_at_,_$v$_primElem)(_$v$_arr, _$v$_idx, _$v$_elem, _$v$_typeRet);\
    _$v$_arr;\
})


#define Array_$_getObjectAtIndex_$_int(_$v$_arr, _$v$_idx, _$v$_primRet, _$v$_typeRet) ({ \
    xcat(_$_Array_object_at_,_$v$_primRet)(_$v$_arr,_$v$_idx,  _$v$_typeRet);                              \
})
